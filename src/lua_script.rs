    ...
    fn lua_ui_functions_live_under_ui_namespace() {
        run_lua_expect_ok(
            ...
            for _, name in ipairs({ "rect", "line", "circle", "extrude", "new", "select",
                                    "constrain", "dimension", "parameter", "export_stl", "export_3mf",

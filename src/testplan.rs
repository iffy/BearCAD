...
const FEATURE_SECTIONS: &[Section] = &[
    ...
    Section {
        ...
        items: &[
            ...
            "Fully constrain a sketch (fully-constrained color)",
        ],
    },
    Section {
    ...
    Section {
        ...
        items: &[
            ...
            "Export 3MF with material colors",
    ...
    Section {
        ...
        items: &[
            ...
            "Create a new material; edit name and color",
            "Mixed materials on a multi-body selection",
            "3MF export writes material colors",
        ],
    },
    Section {
        title: "Components",

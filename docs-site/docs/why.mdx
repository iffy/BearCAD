...
export const Yes = () => (
  <span className="feat-yes" role="img" aria-label="Yes">✔</span>
);
export const No = () => (
  <span className="feat-no" role="img" aria-label="No">✘</span>
);
...
| **Cost** | Choose what to pay | $680/yr; personal-use free (limited) | ~$2,820/yr Standard | Free | Free |

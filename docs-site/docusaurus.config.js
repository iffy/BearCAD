...
const config = {
  ...
  markdown: {
    hooks: {
      ...
      // (scripts/gen-doc-screenshots.sh; Website CI fetches or nightlies them).
      // Warn — don't fail — if they're missing, so a plain `npm run build`
      // still works locally without a render-capable environment.

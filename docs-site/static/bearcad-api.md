...
bearcad.drawing_view_style{ drawing, view, style }   -- visible, wireframe, shaded, colorful, loose_pencil
...
bearcad.ui.camera{ yaw, pitch, distance, target }?   -- no fields = read { …, projection, shading, ground }
...
bearcad.ui.shading(name)   -- wireframe, transparent, solid, solid_wireframe, realistic, loose_pencil, colour_pencil

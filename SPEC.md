...
- **Line + point (#483):** the Plane tool's **Anchor** accepts three complete sets: (1) one
  ...
  the line. Pick either order: after an edge-alone start, click a point to upgrade; after a
  vertex start, click a line to set the normal. The Anchor rows show both labels

...
exports='["_bearcad_kernel_box_volume","_bearcad_kernel_occt_version","_bearcad_shape_prism","_bearcad_shape_loft","_bearcad_shape_cylinder","_bearcad_shape_boolean","_bearcad_shape_fillet","_bearcad_shape_chamfer","_bearcad_shape_volume","_bearcad_shape_tessellate","_bearcad_tri_free","_bearcad_shape_free","_bearcad_face_boolean_loop","_bearcad_pts_free","_bearcad_shape_write_step","_bearcad_read_step","_malloc","_free"]'
